...
<template>
  <div class="form-about-item-edit">
    <n-alert
    ...
    <n-form label-position="top">
      <InputTitle
        v-if="!isLoading"
        :initial-value="aboutItemInformation.title"
        @change-form-values="updateFormValues($event)"
      />
      <InputContent
        v-if="!isLoading"
        :initial-value="aboutItemInformation.content"
        @change-form-values="updateFormValues($event)"
      />
      <InputOrder
        v-if="!isLoading"
        :initial-value="aboutItemInformation.order"
        @change-form-values="updateFormValues($event)"
      />
      <SwitchIsPublished
        v-if="!isLoading"
        :initial-value="aboutItemInformation.isPublished"
        @change-form-values="updateFormValues($event)"
      />
      <n-button
        type="primary"
