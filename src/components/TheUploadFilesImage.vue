<template>
  <div class="the-upload-files-image">
    <p>
      Add Photographs of the Course
    </p>
    <n-button
...
export default defineComponent({
  ...
  setup (props, { emit }) {
    ...
    const emitChange = (fileNames) => {
      emit('changeFormValues', { inputName: 'uploadFilesImage', inputValue: fileNames, isChanged: changedState.isChanged, isValid: isValid.value, errorMessage })
    }
